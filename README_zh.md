...
> **🧭 先读这个：内核 vs 产物**
>
> 很多人会以为「人类知识地基计划」是这个仓库的主角。**其实它只是一个产物。**
>
> - **内核（源头）** = 一场关于「**智能的本质**」的、长达十余万字的极限思辨。
> - **产物（落地）** = 「人类知识地基计划」，它是上述追问推到尽头后，被逻辑逼出来的第一个具体工程。
>
> 如果你只想看工程，可以直接跳到方法论和数据。但如果你想知道**「为什么是这件事，而它的野心到底有多大」**，请务必先读 **[`docs/philosophical_background/`](docs/philosophical_background/README.md)** 这个目录——尤其是开篇的 [《项目缘起：从「智能的本质」到「人类知识地基」》](docs/philosophical_background/00_项目缘起_从智能的本质到知识地基.md)。否则你很容易把它误当成"又一个 AI 知识图谱"，从而严重低估它。
...
这最后一步落地的产物，就是**人类知识地基计划**。完整展开见 [`docs/philosophical_background/`](docs/philosophical_background/README.md)。
